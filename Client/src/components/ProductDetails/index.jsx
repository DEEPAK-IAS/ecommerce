  ...
  return (
    <>
      ...
      <p className="mt-3 pr-10 mb-5">
        ...
        rem earum a accusamus commodi voluptate nihil, nam obcaecati ullam
        veritatis quae nemo natus corporis iure delectus repellat, ipsam saepe.
        Esse eos molestiae alias. A ullam possimus sint nesciunt qui quos
        similique molestiae dolorem recusandae quod, eveniet adipisci eaque
        blanditiis, deleniti expedita ab velit nisi, veritatis porro et? Dolore,
        non.
      </p>
      ...
      <div className="flex items-center gap-4 mt-6">
        <span className="flex items-center gap-3 text-[12px] link cursor-pointer font-[500]">
          {" "}
