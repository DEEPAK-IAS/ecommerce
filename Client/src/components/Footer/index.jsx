...
const Footer = () => {
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="flex items-center justify-center gap-2 py-8 pb-8">
            <div className="col flex items-center justify-center flex-col group w-[15%]">
              <LiaShippingFastSolid className="text-[40px] transition duration-300 group-hover:text-primary group-hover:translate-y-1" />
              <h3 className="text-[16px] font-[600] mt-3">Free Shipping</h3>
              <p className="text-[12px] font-[400]">For all orders Over $100</p>
            </div>
            <div className="col flex items-center justify-center flex-col group w-[15%]">
              <PiKeyReturnLight className="text-[40px] transition duration-300 group-hover:text-primary group-hover:translate-y-1" />
              <h3 className="text-[16px] font-[600] mt-3">30 Days Returns</h3>
              <p className="text-[12px] font-[400]">For all Exchange Product</p>
            </div>
            <div className="col flex items-center justify-center flex-col group w-[15%]">
              <BsWallet2 className="text-[40px] transition duration-300 group-hover:text-primary group-hover:translate-y-1" />
              <h3 className="text-[16px] font-[600] mt-3">Secured payment</h3>
              <p className="text-[12px] font-[400]">Payment Cards Accepted</p>
            </div>
            <div className="col flex items-center justify-center flex-col group w-[15%]">
              <LiaGiftSolid className="text-[40px] transition duration-300 group-hover:text-primary group-hover:translate-y-1" />
              <h3 className="text-[16px] font-[600] mt-3">Special Gifts</h3>
              <p className="text-[12px] font-[400]">Our First Product Order</p>
            </div>
            <div className="col flex items-center justify-center flex-col group w-[15%]">
              <BiSupport className="text-[40px] transition duration-300 group-hover:text-primary group-hover:translate-y-1" />
              <h3 className="text-[16px] font-[600] mt-3">Support</h3>
            ...
            <div className="part1 w-[25%] border-r border-[rgba(0,0,0,0.2)]">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[16px] font-[600]">
                  Online Char <br /> Get Expert Help
                </span>
              </div>
            </div>

            <div className="part2 w-[40%] flex pl-8">
              <div className="part2_col1 w-[50%] mb-4">
              ...
              <div className="part2_col2 w-[50%] mb-4">
      ...
      <div className="bottomStrip border-[rgba(0,0,0,0.2)] py-3 bg-white">
