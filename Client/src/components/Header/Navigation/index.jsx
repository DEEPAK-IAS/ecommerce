...
const Navigation = () => {
  const [isOpenCatePanel, setIsOpenCatePanel] = useState(false);

  const openCategoryPanel = () => {
    setIsOpenCatePanel(true);
  };
  ...
  return (
    <>
      ...
      <CategoryPanel
        isOpenCatePanel={isOpenCatePanel}
        setIsOpenCatePanel={setIsOpenCatePanel}
      />
    </>
  );
};
