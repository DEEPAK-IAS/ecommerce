                ...
                <>
                  ...
                  >
                    ...
                    <div className="info flex flex-col">
                      <h4 className="leading-3 text-[14px] text-[rgba(0,0,0,0.6)] font-[500] mb-1 capitalize text-left justify-start">
                        Deepak surya
                      </h4>
                      <span className="text-[13px] text-[rgba(0,0,0,0.6)] font-[400] capitalize justify-start">
