  ...
  return (
    <div className="productItem rounded-md overflow-hidden border-1 border-[rgba(0,0,0,0.1)] shadow-lg flex items-center">
      <div className="group imgWrapper w-[25%] overflow-hidden  rounded-md relative">
        ...
        <div className="actions absolute top-[-200px] right-[5px] z-50 flex items-center gap-2 flex-col w-[50px] transition-all duration-400 group-hover:top-[15px] opacity-0 group-hover:opacity-100">
      ...
      <div className="info p-3 py-5 px-8 w-[75%]">
        ...
        <h3 className="text-[18px] title mt-3 mb-3 font-[500] text-[#000]">
          <Link to={"/"} className="link transition-all">
            Siril Geogette Pink Color Saree with Blouse Piece
          </Link>
        </h3>

        <p className="text-[14px] mb-3">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nemo nulla quia reiciendis delectus, minima aliquam.</p>
