                ...
                <table className="w-full text-sm text-left text-gray-700 mb-2">
                  ...
                  <tbody>
                    <tr className="bg-white border-b dark:bg-gra-800 dark:border-gray-700">
                      ...
                      <td className="px-6 py-4 font-[500]">
                        <span className="text-primary">68234234349234</span>
                      </td>
                      <td className="px-6 py-4 font-[500]">
                        <span className="text-primary">pay_PTPQqEXFhrtpy8</span>
                      </td>
                      ...
                      <td className="px-6 py-4 font-[500]">
                        <span className="block w-[400px]">
                          ...
                          elit. Error quisquam reprehenderit itaque.
                        </span>
                      </td>
