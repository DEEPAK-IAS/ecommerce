  ...
  return (
    <>
      <div className="w-full py-2 px-5 bg-white border border-[rgba(0,0,0,0.1)] flex items-center gap-8 mb-5 justify-between rounded-md">
        <div className="info">
          <h1 className="inline text-[30px] font-bold leading-8 mb-3">
            Good Morning, <br />
            Cameron
            <PiHandWaving className="text-[35px] text-[#a1a109] inline" />
          </h1>
          <p>
      ...
      <div className="card my-4 shadow-md sm:rounded-lg bg-white">
        ...
        <div className="flex items-center w-full pl-5 pr-5 justify-between">
          ...
          <div className="col w-[25%] flex items-center gap-3">
      ...
      <div className="card my-4 shadow-md sm:rounded-lg bg-white">
        ...
        <div className="flex items-center gap-4 px-5 py-5 pt-1">
