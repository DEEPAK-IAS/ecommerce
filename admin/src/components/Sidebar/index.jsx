    ...
    <>
      ...
      >
        ...
        <ul className="mt-4">
          ...
          <li>
            <Button
              className="w-full !capitalize !justify-start flex gap-3 text-[14px] !text-[rgba(0,0,0,0.8)] font-[500] items-center !py-2"
              ...
              <span className="ml-auto w-[30px] h-[30px] flex items-center">
                <FaAngleDown
                  className={`transition-all ${
                    submenuIndex === 1 ? "rotate-180" : "rotate-0"
                  }`}
                />
              </span>
            </Button>
          ...
          <li>
            ...
            >
              <FaRegImage className="text-[20px]" /> <span>Products</span>
              <span className="ml-auto w-[30px] h-[30px] flex items-center">
                <FaAngleDown
                  className={`transition-all ${
                    submenuIndex === 3 ? "rotate-180" : "rotate-0"
                  }`}
                />
              </span>
            </Button>
          ...
          <li>
            ...
            >
              ...
              <span className="ml-auto w-[30px] h-[30px] flex items-center">
                <FaAngleDown
                  className={`transition-all ${
                    submenuIndex === 4 ? "rotate-180" : "rotate-0"
                  }`}
                />
              </span>
            </Button>
            ...
            <Collapse isOpened={submenuIndex === 4 ? true : false}>
              <ul className="w-full">
                ...
                <li className="w-full">
                    <Button className="!text-[rgba(0,0,0,0.8)] !capitalize !justify-start !w-full !text-[13px] font-[500] !pl-9 flex gap-3" onClick={() =>
                      context.setIsOpenFullScreenPanel({
                        open: true,
